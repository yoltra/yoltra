...
Siga as instruções em **Quo.js** sobre
[como criar uma Store](https://quojs.dev/?lang=pt).
...
- [Desarrollador](https://quojs.dev/?lang=pt): guía de inicio rápido, tutorial, gists, 
  etc. 
- [TypeDoc](./docs/en/README.md): una documentación más técnica extraída utilizando TypeDoc. 
