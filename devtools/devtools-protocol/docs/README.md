...
- [HandshakeRequest](interfaces/HandshakeRequest.md)
...
- [SamplingConfig](interfaces/SamplingConfig.md)
- [StateSnapshot](interfaces/StateSnapshot.md)
- [StoreCapabilities](interfaces/StoreCapabilities.md)
- [StoreConnected](interfaces/StoreConnected.md)
- [StoreDisconnected](interfaces/StoreDisconnected.md)
- [StoreEvent](interfaces/StoreEvent.md)
- [StoreMetrics](interfaces/StoreMetrics.md)
- [StoreRegistry](interfaces/StoreRegistry.md)
- [StoreSubscriptions](interfaces/StoreSubscriptions.md)
- [TimeTravel](interfaces/TimeTravel.md)
